...
/**
 * input_buf - Buffer chained commands for input processing
 * @info: Parameter struct holding relevant information
 * @buf: Address of the buffer to store the input
 * @len: Address of the length variable to track input length
...
/**
 * sigintHandler - Handle the Ctrl-C signal, blocking its default behavior
